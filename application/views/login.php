							...
							<div class="tab-pane fade in active" id="basic-tab1">
								<form  action="<?php echo base_url();?>User/varifyUser" method="post">
									<div class="text-center" >
										<!--<img class="img-responsive" src="<?php echo base_url('assets/frontend/images/newlogo.png');?>" height="100" width="100" style="margin:0 auto;"> -->
										<h1 class="text-orange-800">Sugavans Photography</h1>
									...
									<?php
										...
										?>
											<div class="alert alert-danger alert-bordered alert-rounded">
												...
												<span class="text-semibold">Oh snap!</span> <?php echo  $this->session->flashdata('login');?>
											</div>
...
<!--
									...
									<div class="form-group">
										<button type="submit" class="btn bg-orange-800 btn-block">Login <i class="icon-arrow-right14 position-right"></i></button>
									</div>
								</form>

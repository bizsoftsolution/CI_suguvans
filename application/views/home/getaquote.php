        ...
        ?>
            ...
            <div class="tsf-wizard tsf-wizard-1">
                ...
                <div class="tsf-container">
                    ...
                    <!-- BEGIN CONTENT-->
                    <form class="tsf-content" action="<?php echo base_url(); ?>Home/Addquote" method="POST" data-parsley-validate="" id="getaquote">
                        ...
                        <div class="tsf-step step-1 active">
                            <fieldset>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" id="phone_number" name="phone_number" placeholder="Phone Number" maxlength="12" required>
										</div>
										<div class="form-group">
								...
								<div class="row">
									...
									<div class="col-lg-12">
										<div class="radio">
										  <label><input type="radio" name="eventdetails" value="Brahmin Wedding ( All Major Events )" class="eventdetails" required="">Brahmin Wedding ( All Major Events )</label>
										</div>
										<div class="radio">
										  <label><input type="radio" name="eventdetails" value="Brahmin Telugu Wedding ( All Major Events )" class="eventdetails">Brahmin Telugu Wedding ( All Major Events )</label>
										</div>
										<div class="radio">
										  <label><input type="radio" name="eventdetails" value="Muslim Wedding + Reception" class="eventdetails">Muslim Wedding + Reception</label>
										</div>
										<div class="radio">
										  <label><input type="radio" name="eventdetails" value="Non Brahmin Telugu Wedding ( All Events )" class="eventdetails">Non Brahmin Telugu Wedding ( All Events )</label>
										</div>
										<div class="radio">
										  <label><input type="radio" name="eventdetails" value="Normal Hindu Engagement + Wedding + Reception" class="eventdetails">Normal Hindu Engagement + Wedding + Reception</label>
										</div>
										<div class="radio">
										  <label><input type="radio" name="eventdetails" value="Normal Hindu Wedding + Reception" class="eventdetails">Normal Hindu Wedding + Reception</label>
										</div>
										<div class="radio">
										  <label><input type="radio" name="eventdetails" value="Christian Wedding + Reception"class="eventdetails">Christian Wedding + Reception</label>
										</div>
										<div class="radio">
										  <label><input type="radio" name="eventdetails" value="Engagement Only" class="eventdetails">Engagement Only</label>
										</div>
										<div class="radio">
										  <label><input type="radio" name="eventdetails" value="Wedding Muhurtham Only" class="eventdetails">Wedding Muhurtham Only</label>
										</div>
										
										<div class="radio">
										  <label><input type="radio" name="eventdetails" value="Reception Only" class="eventdetails">Reception Only</label>
										</div>
										<div class="radio">
										  <label><input type="radio" name="eventdetails" value="Baby Shower" class="eventdetails">Baby Shower</label>
										</div>
										<div class="radio">
										  <label><input type="radio" name="eventdetails" value="other" class="eventdetails">Other: <input type="text" name="eventdetails1" value="" id="eventDetailopen" readonly></label>
										</div>
									</div>
									<script>
										$(document).ready(function(){
											   $('.eventdetails').click(function(){
												 ...
												 if(rBtnVal == "other"){
													 $("#eventDetailopen").attr("readonly", false); 
												 }
												 else{ 
													 $("#eventDetailopen").attr("readonly", true); 
												 }
											   });
											});
									</script>
								...
								<div class="row">
									...
									<div class="col-lg-12">
										<div class="form-group">
											<!--label for="phone_number">Mobile Number</label-->
											<select class="form-control" id="heard" name="eventmonth">
                            ...
                            <fieldset>
                                ...
                                <div class="tsf-step-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="radio">
										  <label><input type="radio" name="budget" value="INR 50,000/- to INR 1,10,000/-" required="">INR 50,000/- to INR 1,10,000/-</label>
										</div>
										<div class="radio">
                            ...
                            <fieldset>
                                ...
                                <div class="tsf-step-content">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="guests" placeholder="" required>
                                    </div>
									 <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="additionalinformation" placeholder="" required>
                                    </div>
									<div class="form-group">
                                        <label>How do you know Sugavans Photography?</label>
                                        <div class="radio">
										  <label><input type="radio" name="knows" value="Facebook Page" class="knows" required="">Facebook Page</label>
										</div>
										<div class="radio">
										  <label><input type="radio" name="knows" value="Google Search / Website" class="knows">Google Search / Website</label>
										</div>
										<div class="radio">
										  <label><input type="radio" name="knows" value="Referral" class="knows">Referral</label>
										</div>
										<div class="radio">
										  <label><input type="radio" name="knows" value="other" class="knows">Other:<input type="text" name="knows1" value="" id="knowsopen"></label>
										</div>
                                    </div>
									<script>
										$(document).ready(function(){
											   $('.knows').click(function(){
												 ...
												 if(rBtnVal == "other"){
													 $("#knowsopen").attr("readonly", false); 
												 }
												 else{ 
													 $("#knowsopen").attr("readonly", true); 
												 }
											   });
											});
									</script>
                                    <div class="form-group">
										...
										<div class="radio">
										  <label><input type="radio" name="representative" value="No one. I filled it by seeing the form online myself." class="representative" required="">No one. I filled it by seeing the form online myself.</label>
										</div>
										<div class="radio">
										  <label><input type="radio" name="representative" value="other" class="representative">Other:<input type="text" name="representative1" value="" id="representativeopen"></label>
										</div>
                                    </div>
									<script>
										$(document).ready(function(){
											   $('.representative').click(function(){
												 ...
												 if(rBtnVal == "other"){
													 $("#representativeopen").attr("readonly", false); 
												 }
												 else{ 
													 $("#representativeopen").attr("readonly", true); 
												 }
											   });
											});
									</script>

               ...
               <div class="container">
				...
				<div class="row">
					...
					<div class="col-md-3">
						...
						<div class="products" style="margin:0 auto;">
...
<script src="<?php echo base_url(); ?>assets/typing/typed.min.js" type="text/javascript"></script>
  <script src="<?php echo base_url(); ?>assets/typing/demos.js"></script>
 <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true"  id="myModal" style="top:100px;">

    <div class="modal-dialog">

      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header" style="background-color:#ff7800;color:#fff;">
          <button type="button" class="close" data-dismiss="modal">×</button>
          <h4 class="modal-title" style="text-align:center;font-family: cursive;
    font-size: 21px;">Subscribe for Exciting Offers !!!!!</h4>
        </div>
        <div class="modal-body">
			<center><h1 style="color:red;">
			<!--div class="type-wrap">
				<div id="typed-strings">
				  <span>Special Offer<strong>!!!!!</strong></span>
		  ...
		  <script>
			 var typed5 = new Typed('#typed5', {
				strings: ['Avail Special Offer', 'Please subscribe!!!'],
				typeSpeed: 20,
				backSpeed: 20,
				//cursorChar: '',
				//shuffle: true,
				...
				loop: true
					...
					<p class="statusMsg" style="text-align:center;"></p>
					<form class="form-horizontal">
                       ...
                       <div class="form-body">
                           ...
                           <div class="form-group">
                               ...
                               <div class="col-md-9">
                                   <input name="phone_no" id="phone_no" placeholder="Phone Number" class="form-control" type="number" maxlength="12">
                                   <span class="help-block"></span>
                               </div>
                           </div>
		...
		<div class="modal-footer" style="text-align:center;">
                   <button type="button" id="btnSave" onclick="save()" class="btn btn-success">Subscribe</button>
...
<script>
   ...
   function save()
   {
	...
	{
		alert('Please put 12 digit mobile number');
        $('#phone_no').focus();
        return false;
	}
	else{
		...
		$.ajax({
            ...
            success:function(msg){
                if(msg == 'err'){
					...
					$('#phone_no').val('');
                    $('#email_id').val('');
                    $('.statusMsg').html('<span style="color:green;">Thanks for Subscribe us, we\'ll get back to you soon.</p>');
                }

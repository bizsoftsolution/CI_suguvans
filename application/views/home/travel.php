...
<div class="we-are">
  <div class="container">
    ...
    <div class="title1 animated" data-animation="fadeInUp" data-animation-delay="100">  <h1 style="text-align:center;"><span style="color:#ff7800;">T</span>ravel & <span style="color:#ff7800;">D</span>ocumentary</h1></div>
   ...
   <!--  <div class="title2 animated" data-animation="fadeInUp" data-animation-delay="200">A Great photograph is a full expression of what one feels what is being photographed in the deepest sense and is, therby,<br>a true expression of what one feels about life in its entirety.
    ...
    <br><br>
<?php $portrait = $this->db->get_where('tbl_album',array('category_id'=>'6'))->result();
		$i=1;		  
foreach($portrait as $rportrait)
{
	...
	?>
	 ...
	 <div class="col-sm-4">
        <div class="thumb1 animated" data-animation="flipInY1" data-animation-delay="400">

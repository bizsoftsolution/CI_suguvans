   ...
   <div class="col-lg-12">
      ...
      <div class="panel panel-flat">
         <div class="panel-heading">
            <h2 class="panel-title">Blog Details</h2>
         ...
         <div class="container-fluid">
            ...
            <div class="col-md-10">
               ...
               <?php foreach($getEditdata as $row){?>
				...
				<form name="add"   method="POST" action="<?php echo  base_url();?>Blog/edit_blog/<?php echo $row->id;?>" class="form-horizontal" enctype= "multipart/form-data">
                    ...
                    <div class="form-body">
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="blog_name" placeholder="Blog name" class="form-control" type="text" value="<?php echo $row->blog_name; ?>">
                       ...
                       <div class="form-group">
						...
						foreach($img as $rowimg)
						{
							...
							<div class="col-md-6">
							<img src="<?php echo base_url(); ?>upload/blog/<?php echo $rowimg; ?>" class="img-responsive" style="width:180px; height:100px;margin:0 0 5px 0;">

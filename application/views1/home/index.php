    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header" style="background-color:#ff7800;color:#fff;">
          ...
          <h4 class="modal-title" style="text-align:center;">Subscribe for Exisiting Offers !!!!!</h4>
        </div>
			 ...
			 <form action="#" id="form" class="form-horizontal">
                       ...
                       <div class="form-body">
                           <div class="form-group">
                               ...
                               <div class="col-md-9">
                                   <input name="email_id" placeholder="Email Id" class="form-control" type="email">
                           ...
                           <div class="form-group">
                               ...
                               <div class="col-md-9">
                                   <input name="phone_no" placeholder="Phone Number" class="form-control" type="number">
                                   <span class="help-block"></span>
                               </div>
                           </div>
